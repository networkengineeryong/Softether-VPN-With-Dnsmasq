...
[3-1. 카드 리더기가 없는 일반 보관함 서버 dnsmasq 설정](#카드-리더기가-없는-보관함-서버의-경우)

[3-2. 카드 리더기가 있는 아파트 보관함 서버 dnsmasq 설정](#카드-리더기가-있는-아파트-보관함-서버의-경우)
...
## 카드 리더기가 있는 아파트 보관함 서버 dnsmasq 설정
