...
* /etc/hosts 파일에 vpnserver ip 지정
    ...
    __/etc/hosts__ 파일에 __vpnserver__ 의 __IP__ 를 __현장 서버 IP__ 로 변경 혹은 추가해 주면 됩니다 ([참고](#/etc/hosts-파일에-vpnserver-ip-지정))
...
* 카드 단말기가 __없는__ 아파트 모델일 경우
    ...
    __/etc/dnsmasq.conf__ 파일에 __eth1__ 설정들 주석처리
